...
//
// On Thu Dec  6 03:31:06 UTC 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkTX(baud_rate,
  ...
  assign data_send =
	     !data_fifo$dEMPTY_N ||
	     count != 4'd0 && data_fifo$dD_OUT[i__h348] ;
